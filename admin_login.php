			...
			if(strlen($user_name)==0 || strlen($password)==0)
				{
					...
					{
						$isLogin=admin_login($conn,$user_name,$password,$super_admin);
						if($isLogin)
						{
...
<html lang="en">
	...
	<body>
		...
		<div class="row">
			<div class="col-md-5 col-md-offset-3" style="background:#28ABC7;">
			<form  name="login" id="login" action="admin_login.php" method="post">	
